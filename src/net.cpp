...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "DollHairs " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dollhairs.net", "seed.dollhairs.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"dollhairs.net", "testnet-seed.dollhairs.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. DollHairs is probably already running."), addrBind.ToString().c_str());
        else
