...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 DLRS
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 DLRS mininput
/** No amount larger than this (in satoshi) is valid */
static const uint64 MAX_MONEY = 500000000000 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1800 / 250;
    }
