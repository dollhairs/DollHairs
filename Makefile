#############################################################################
# Makefile for building: dollhairs-qt
# Generated by qmake (2.01a) (Qt 4.8.5) on: Sat Feb 15 13:59:05 2014
# Project:  dollhairs-qt.pro
# Template: app
# Command: c:/Qt/4.8.5/bin/qmake.exe -o Makefile dollhairs-qt.pro
#############################################################################
...
Makefile: dollhairs-qt.pro  ../Qt/4.8.5/mkspecs/default/qmake.conf ../Qt/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -o Makefile dollhairs-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/newcoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/newcoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/newcoin/src/leveldb/libleveldb.a: FORCE
	cd C:/newcoin/src/leveldb && CC=gcc CXX=g++ TARGET_OS=OS_WINDOWS_CROSSCOMPILE $(MAKE) OPT="-pipe -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a && ranlib C:/newcoin/src/leveldb/libleveldb.a && ranlib C:/newcoin/src/leveldb/libmemenv.a
